...
class Config:
    ...
    AI_DEFAULT_MAX_TOKENS = int(os.getenv('AI_DEFAULT_MAX_TOKENS', 180))
    AI_SUMMARY_MAX_TOKENS = int(os.getenv('AI_SUMMARY_MAX_TOKENS', 140))
    AI_REPLY_MAX_TOKENS = int(os.getenv('AI_REPLY_MAX_TOKENS', 160))
    AI_ANALYZE_MAX_TOKENS = int(os.getenv('AI_ANALYZE_MAX_TOKENS', 140))
